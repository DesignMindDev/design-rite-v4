        ...
        <nav className="max-w-6xl mx-auto px-8 flex justify-between items-center">
          ...
          <ul className="hidden lg:flex items-center gap-10">
            ...
            <li className="relative group">
              <span className="text-purple-600 font-medium transition-all relative py-2 block text-sm cursor-pointer after:absolute after:bottom-[-5px] after:left-0 after:w-full after:h-0.5 after:bg-gradient-to-r after:from-purple-600 after:to-purple-700">
                Solutions
              </span>
              <div className="absolute top-full left-0 mt-4 bg-black/95 backdrop-blur-xl border border-purple-600/30 rounded-xl p-4 min-w-[280px] opacity-0 invisible transform -translate-y-2 transition-all group-hover:opacity-100 group-hover:visible group-hover:translate-y-0 shadow-2xl">
                ...
                <Link href="/consultants" className="flex items-center gap-4 p-3 rounded-lg text-purple-600 bg-purple-600/10 transition-all hover:translate-x-1">
                  <div className="w-10 h-10 bg-purple-600/30 rounded-lg flex items-center justify-center text-2xl flex-shrink-0">
                    💼
                  </div>
                  <div>
                    <div className="font-semibold text-sm text-purple-300 mb-1">Security Consultants</div>
                    <div className="text-xs text-purple-400 leading-tight">Expert advisory services</div>
                  </div>
                </Link>
              </div>
            </li>
        ...
        {isMenuOpen && (
          <div className="lg:hidden bg-black/20 backdrop-blur-sm border-t border-white/10">
            <div className="px-6 py-4 space-y-4">
              ...
              <Link href="/consultants" className="block text-purple-600 font-medium py-2">Security Consultants</Link>
