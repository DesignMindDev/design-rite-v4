-- COMPLETE DESIGN-RITE PLATFORM MIGRATION
...
-- 1. Core Platform (products, assessments, demo bookings, etc.)
-- 2. Creative Studio
-- 3. Spatial Studio
-- 4. Insight Studio (Harvester)
--
-- IMPORTANT: Make sure you've already run FRESH_START_SUBSCRIPTION_PROJECT.sql first!
-- This script adds the studio tables to the core infrastructure.
...
CREATE INDEX IF NOT EXISTS idx_spatial_projects_user_id ON spatial_projects(user_id);
...
BEGIN
  ...
  RAISE NOTICE '';
  RAISE NOTICE 'Spatial Studio Tables: 7';
