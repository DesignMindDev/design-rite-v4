-- Create Test Users for Staging Environment
...
-- ==============================================
-- CREATE SUPABASE AUTH USERS (No Email Verification)
-- ==============================================
...
BEGIN
  ...
  RAISE NOTICE '';
  RAISE NOTICE 'Test login at: https://design-rite-staging.onrender.com/login';
END $$;
